...
coverImage: "/projects/card/card_2.png"
featured: true
readingTime: 7
---
...
**Source Code:** [GitHub](https://github.com/nestorraul631/3d-portfolio-card)
...
<html lang="en">
  <head>
    ...
    <title>Card | Nestor Fanelli</title>
  </head>
  <body>
...
const linkPos = {
  ...
  box2: {
    ...
    z: 0.03,
    name: "ClickableBox2",
    link: "https://portfolio-nestor-ea96.vercel.app/",
  },
  circle1: {
    x: -0.46,
    y: -1.06,
...
loader.load("/nestor_card.glb", (gltf) => {
  mesh = gltf.scene;
  mesh.traverse((child) => {
...
- 💻 **Source Code:** [github.com/nestorraul631/3d-portfolio-card](https://github.com/nestorraul631/3d-portfolio-card)
