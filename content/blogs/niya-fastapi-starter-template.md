...
**Repo:** [github.com/nestorraul631/niya-fastapi-template](https://github.com/nestorraul631/niya-fastapi-template)
...
- **[API Reference](https://github.com/nestorraul631/niya-fastapi-template/blob/master/docs/API_REFERENCE.md)** — every endpoint, request/response format, auth requirements
- **[Postman Setup Guide](https://github.com/nestorraul631/niya-fastapi-template/blob/master/docs/POSTMAN_SETUP_GUIDE.md)** — import and test in 2 minutes
- **[API Testing Guide](https://github.com/nestorraul631/niya-fastapi-template/blob/master/docs/API_TESTING_GUIDE.md)** — strategies for unit, integration, and e2e tests
- **[Quick Reference](https://github.com/nestorraul631/niya-fastapi-template/blob/master/docs/API_QUICK_REFERENCE.md)** — cheat sheet for common operations
- **[Architecture Guide](https://github.com/nestorraul631/niya-fastapi-template/blob/master/ARCHITECTURE.md)** — why the code is structured the way it is
- **[New Feature Guide](https://github.com/nestorraul631/niya-fastapi-template/blob/master/NEW_FEATURE_GUIDE.md)** — step-by-step instructions for extending the template
...
```bash
# Clone
git clone https://github.com/nestorraul631/niya-fastapi-template.git
cd niya-fastapi
...
Niya FastAPI is designed to pair perfectly with the [Niya SaaS Template](https://github.com/nestorraul631/niya-saas-template) (Next.js frontend). Together, they give you:
...
**Star it if it's useful:** [github.com/nestorraul631/niya-fastapi-template](https://github.com/nestorraul631/niya-fastapi-template)
